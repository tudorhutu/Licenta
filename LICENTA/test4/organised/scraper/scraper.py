...
def imagescrape():
    try:
        ...
        output_dir = './output/Lynx' # path to output
        #base_url = 'https://stock.adobe.com/search?gallery_id=Pnb3vT0akesPgEDqaqSlBRifOFBa3LoJ' # url to the images
        base_url = 'https://stock.adobe.com/search/images?filters%5Bcontent_type%3Aphoto%5D=1&filters%5Bcontent_type%3Aimage%5D=1&filters%5Bcopy_space%5D=all&filters%5Bcontent_type%3Aillustration%5D=0&filters%5Bcontent_type%3Azip_vector%5D=0&k=lynx&order=relevance&safe_search=1&limit=100&search_page=1&search_type=autosuggest&acp=1&aco=ly&get_facets=1' # url to the images
